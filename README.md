...
<p align="center"><sub><strong>Real product UI.</strong> The screenshot is generated by the repository's Playwright documentation workflow using isolated E2E data; it is product evidence, not release-certification evidence.</sub></p>
...
| **Maintain project identity** | [Branding & Discoverability](docs/branding-and-discovery.md) · screenshot, social-preview and rename guidance |
