# Historical Roadmap — 2026-08-04

> Historical snapshot for the MySQL/Redis-era architecture. Superseded by
> [the current roadmap](../roadmap.md); completion claims here do not certify
> PostgreSQL/RabbitMQ or the current Windows runtime.
...
Historical issues and point-in-time evidence are retained in the [2026-07 platform audit](platform-audit-2026-07.md), the [2026-07-22 independent audit](independent-audit-2026-07-22.md), the [2026-07-23 remediation tracker](independent-audit-remediation-2026-07-23.md), the [2026-07-24 independent re-audit](independent-audit-2026-07-24.md), the [2026-07-25 P0 trust release](p0-trust-release-2026-07-25.md), `docs/audit/actual-environment-system-review-2026-08-02.md`, and the [history index](README.md).
