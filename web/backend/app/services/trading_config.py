...
ASHARE_DEFAULTS: dict[str, Any] = {
    ...
    "slippageBps": 5.0,
    "participationImpactBps": 25.0,
    "maxSlippageBps": 50.0,
    "maxVolumeParticipation": None,
...
def ashare_trading_config(parameters: dict[str, Any] | None = None, request_data: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "participationImpactBps": _float_value(params, request, "participationImpactBps", "participation_impact_bps", default=ASHARE_DEFAULTS["participationImpactBps"]),
        "maxSlippageBps": _float_value(params, request, "maxSlippageBps", "max_slippage_bps", default=ASHARE_DEFAULTS["maxSlippageBps"]),
        "maxVolumeParticipation": _float_value(params, request, "maxVolumeParticipation", "max_volume_participation", default=ASHARE_DEFAULTS["maxVolumeParticipation"]),
