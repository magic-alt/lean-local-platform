    ...
    <>
      ...
      <Tabs
        ...
        <Form form={historyForm} layout="inline" style={{ marginBottom: 12 }} initialValues={filters} onFinish={applyHistoryFilters}>
          ...
          <Form.Item name="projectId" label="Project"><Select data-testid="history-project-select" virtual={false} showSearch optionFilterProp="label" allowClear placeholder="Project" style={{ width: 220 }} options={projectSelectOptions(projects.data)} /></Form.Item>
